import {
  TimesIcon
} from "./chunk-QUU2SRZJ.js";
import {
  animate,
  style,
  transition,
  trigger
} from "./chunk-OCB4J7JD.js";
import {
  BaseIcon,
  Ripple,
  RippleModule
} from "./chunk-APCBYSBQ.js";
import {
  CommonModule,
  NgClass,
  NgForOf,
...
function Messages_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵproperty("ngIf", ctx_r3.closable && (msg_r1.closable ?? true));
  }
}
